...
class Mod(commands.Cog):
    ...
    async def mod(self, ctx, selected_page: int = 1):
        ...
        if cfg.get("theme")["style"] == "codeblock":
            ...
            embed = embedmaker.Embed(title="Moderation Commands", description=pages["image"][selected_page - 1], colour=cfg.get("theme")["colour"])
    ...
    async def clear(self, ctx, number: int):
        ...
        if cfg.get("theme")["style"] == "codeblock":
            ...
            embed = embedmaker.Embed(title=f"Clear", description=f"Purged {len(deleted) - 1} messages.", colour=cfg.get("theme")["colour"])
    ...
    async def ban(self, ctx, member: discord.Member):
        ...
        try:
            ...
            if cfg.get("theme")["style"] == "codeblock":
                ...
                embed = embedmaker.Embed(title=f"Banned User", description=f"Banned {member.name}#{member.discriminator} from the server.", colour=cfg.get("theme")["colour"])
                embed.set_footer(text=cfg.get("theme")["footer"])
                embed_file = embed.save()
            ...
            if cfg.get("theme")["style"] == "codeblock":
                ...
                embed = embedmaker.Embed(title=f"Error", description=f"{e}", colour=cfg.get("theme")["colour"])
                embed.set_footer(text=cfg.get("theme")["footer"])
                embed_file = embed.save()
    ...
    async def kick(self, ctx, member: discord.Member):
        ...
        try:
            ...
            if cfg.get("theme")["style"] == "codeblock":
                ...
                embed = embedmaker.Embed(title=f"Kicked User", description=f"Kicked {member.name}#{member.discriminator} from the server.", colour=cfg.get("theme")["colour"])
                embed.set_footer(text=cfg.get("theme")["footer"])
                embed_file = embed.save()
